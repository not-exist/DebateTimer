...
const threeSpeakerMiddle: FlowTemplate = {
  ...
  stages: [
    stage({
      id: 'm-1', name: '正方一辩立论', side: 'pro', speaker: '一辩',
      timing: single(min(3)), prompts: cardPrompts(30),
    }),
    stage({
      id: 'm-2', name: '反方一辩立论', side: 'con', speaker: '一辩',
      timing: single(min(3)), prompts: cardPrompts(30),
    }),
...
export const PRESETS: FlowTemplate[] = [
  fourSpeakerUniv,
  singapore,
  threeSpeakerMiddle,
  oregon,
